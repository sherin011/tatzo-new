/*
Usage:
  node scripts/delete-auth-user.js <user-email-or-uid>
...
if (!target) {
  console.error('Usage: node scripts/delete-auth-user.js <user-email-or-uid>');
  process.exit(1);
}
...
(async () => {
  try {
    ...
    console.log('Auth user deleted successfully:', userRecord.uid);
  } catch (err) {
